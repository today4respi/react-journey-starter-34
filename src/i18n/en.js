export default {
  ...
  reservation: {
    ...
    confirmText: 'Please confirm the details of your reservation.',
    confirm: 'Confirm',
    persons: 'people',
    person: 'person',
    successTitle: 'Reservation Confirmed!',
    successText: 'Your reservation has been successfully registered. You will receive a confirmation email.',
