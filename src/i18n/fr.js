export default {
  ...
  forgotPassword: {
    ...
    subtitle: "Suivez les étapes pour récupérer votre compte",
    emailDescription: "Saisissez votre adresse e-mail et nous vous enverrons un code de vérification pour réinitialiser votre mot de passe.",
    ...
    emailError: "Échec de l'envoi du code. Veuillez réessayer.",
    
    verificationDescription: "Entrez le code de vérification à 4 chiffres envoyé à",
    verify: "Vérifier",
    ...
    resetPasswordDescription: "Créez un nouveau mot de passe pour votre compte.",
    ...
    returnToLogin: "Retourner à la connexion"
  },
  historicalPlaces: {
