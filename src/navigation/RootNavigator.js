...
const RootNavigator = () => {
  // Use a fallback for AuthContext to prevent undefined errors
  const authContext = useContext(AuthContext) || { loading: true, isAuthenticated: false };
  ...
  // Return the appropriate navigator stack based on authentication status
