      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="relative px-4 md:px-0">
          ...
          >
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <div className="relative aspect-[3/4] overflow-hidden bg-slate-100 mb-4 md:mb-6">
                        ...
                        {/* Heart (Like) Button - Always visible, smaller, gold color */}
                        <div className="absolute top-2 md:top-4 right-2 md:right-4">
                          <Button 
                            size="sm" 
                            variant="ghost" 
                            className="w-6 h-6 md:w-8 md:h-8 p-0 bg-white/90 hover:bg-white shadow-sm rounded-full"
                      ...
                      <div className="text-left px-1">
                        ...
                        <div className="flex items-center gap-2 md:gap-3">
                          ...
                          {product.originalPrice && (
                            <span className="text-sm text-yellow-600 line-through font-light">{product.originalPrice}</span>
                          )}
                        </div>
                      </div>
                    </div>
            ...
            {/* Custom Navigation Arrows - Gold color, better mobile positioning */}
            <CarouselPrevious className="absolute -left-2 md:-left-6 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 border-2 border-yellow-600 bg-white hover:bg-yellow-600 hover:text-white text-yellow-600 transition-all duration-300 shadow-lg" />
            <CarouselNext className="absolute -right-2 md:-right-6 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 border-2 border-yellow-600 bg-white hover:bg-yellow-600 hover:text-white text-yellow-600 transition-all duration-300 shadow-lg" />
          </Carousel>
        </div>
