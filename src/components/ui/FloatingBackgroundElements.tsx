      ...
      {elements.map((element) => (
        <div
          ...
          className={`absolute transition-all duration-1000 ease-out ${
            element.isFixed 
              ? 'opacity-100 scale-100 translate-y-0' // Fixed elements always visible
              : isVisible 
          ...
          style={{
            ...
            zIndex: element.isFixed && (element.id.includes('hero-title') || element.id.includes('educational-stories')) ? 1 : 'auto', // Lower z-index for background clouds
          }}
        >
          <img
            src={element.image}
