    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-8">
          ...
          {/* Breadcrumb */}
          <nav className="flex items-center gap-2 text-sm mb-6 font-hm-sans">
          ...
          {/* Page title */}
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-light text-black mb-4 font-hm-sans">
              {getPageTitle()}
            </h1>
            <p className="text-gray-600 font-hm-sans max-w-2xl mx-auto">
              {subcategory 
        ...
        {products.length > 0 ? (
          <>
            ...
            <div className="flex items-center justify-between mb-8">
              <p className="text-gray-600 font-hm-sans">
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-2 font-hm-sans">
