                ...
                <div className="lg:px-8 mb-16 md:mb-20 relative">
                  ...
                  <div className="lg:hidden relative">
                    ...
                    <div className="absolute -left-16 -top-12 w-96 h-96 z-0">
                      ...
                      <div className="absolute -bottom-2 -right-2 w-3 h-3 bg-pink-300/50 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
                    ...
                    <div className="text-center relative z-10 py-8 pt-20">
                      ...
                      <button 
                        ...
                        className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 md:py-4 px-8 md:px-12 rounded-full text-sm md:text-base transition-all duration-300 transform hover:scale-105 shadow-lg font-baloo"
                      >
