...
const ProductModalContent = ({ 
  ...
  const shouldShowShoeSizes = () => {
    return formData.itemgroup_product === 'chaussure';
  };
    ...
    <DialogContent className="max-w-4xl w-[95vw] max-h-[90vh] p-0 bg-white border border-gray-200 overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6">
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          {/* Sizes Section */}
          {shouldShowSizes() && (shouldShowLetterSizes() || shouldShowCostumeSizes() || shouldShowShoeSizes()) && (
            <div className="bg-gray-50 rounded-lg border border-gray-200 p-4 sm:p-6">
              ...
              {shouldShowShoeSizes() && (
                <div>
                  <Label className="text-sm font-medium text-gray-700 mb-3 block">Pointures Chaussures (38 - 46)</Label>
                  <div className="grid grid-cols-3 sm:grid-cols-9 gap-3">
                    {['38_size', '39_size', '40_size', '41_size', '42_size', '43_size', '44_size', '45_size', '46_size'].map(size => (
                      <div key={size} className="text-center">
                        <Label className="text-xs font-medium text-gray-600 block mb-1">
                          {size.replace('_size', '')}
                        </Label>
    ...
    try {
      ...
      if (data.success) {
        ...
        setFormData({
          ...
          '38_size': productData['38_size']?.toString() || '',
          '39_size': productData['39_size']?.toString() || '',
          '40_size': productData['40_size']?.toString() || '',
          '41_size': productData['41_size']?.toString() || '',
          '42_size': productData['42_size']?.toString() || '',
          '43_size': productData['43_size']?.toString() || '',
          '44_size': productData['44_size']?.toString() || '',
          '45_size': productData['45_size']?.toString() || '',
          '46_size': productData['46_size']?.toString() || '',
