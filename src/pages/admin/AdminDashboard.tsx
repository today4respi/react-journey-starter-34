...
const AdminDashboard = () => {
  ...
  const chartData = [
    { name: 'Jan', orders: 65, revenue: 8400 },
    { name: 'Fév', orders: 85, revenue: 11200 },
    { name: 'Mar', orders: 125, revenue: 16800 },
    { name: 'Avr', orders: 95, revenue: 12600 },
    { name: 'Mai', orders: 145, revenue: 19200 },
    { name: 'Jun', orders: 165, revenue: 22400 }
  ];
  ...
  const recentOrders = [
    { id: 1, customer: 'Jean Dupont', amount: 485.00, status: 'confirmed', time: '10:30' },
    { id: 2, customer: 'Marie Martin', amount: 320.00, status: 'pending', time: '11:15' },
    { id: 3, customer: 'Pierre Dubois', amount: 650.00, status: 'processing', time: '12:45' }
  ];
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-green-100 hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-green-900 mb-1">
                €{statsData.revenueToday.toLocaleString('fr-FR')}
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg">
                <div className="text-2xl font-bold text-blue-900 mb-1">
                  {statsData.visitorsTotal.toLocaleString('fr-FR')}
                </div>
              ...
              <div className="text-center p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg">
                <div className="text-2xl font-bold text-purple-900 mb-1">
                  {statsData.newsletterSubscribers.toLocaleString('fr-FR')}
                </div>
