                ...
                <CardContent className="p-4 sm:p-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center text-sm">
                      ...
                      <span className="text-gray-900 font-medium">{subtotal.toFixed(2)} TND</span>
                    </div>
                    ...
                    {hasNewsletterDiscount && (
                      <div className="flex justify-between items-center text-sm">
                        ...
                        <span className="text-green-600 font-medium">-{newsletterDiscount.toFixed(2)} TND</span>
                      </div>
                    )}
                    {appliedDiscount > 0 && (
                      <div className="flex justify-between items-center text-sm">
                        <span className="text-gray-600">{t('orderSummary.discount')}</span>
                        <span className="text-green-600 font-medium">-{appliedDiscount.toFixed(2)} TND</span>
                      </div>
                    )}
                    <div className="flex justify-between items-center text-sm">
                      <span className="text-gray-600">{t('orderSummary.shipping')}</span>
                      <span className="text-gray-900">{deliveryCost.toFixed(2)} TND</span>
                    </div>
                    ...
                    {(itemDiscountTotal + appliedDiscount + newsletterDiscount) > 0 && (
                      <div className="flex justify-between items-center text-sm bg-green-50 p-2 rounded-lg">
                        ...
                        <span className="text-green-700 font-bold">{(itemDiscountTotal + appliedDiscount + newsletterDiscount).toFixed(2)} TND</span>
                      </div>
                    )}
                  </div>
