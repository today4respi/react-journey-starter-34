...
import { getAllProperties, deleteProperty, Property } from '../../services/propertyService';
...
const PropertiesListScreen = () => {
  ...
  const renderProperty = ({ item }: { item: Property }) => (
    <View style={styles.propertyCard}>
      <TouchableOpacity 
        onPress={() => navigation.navigate('PropertyDetails' as never, { propertyId: item.id } as never)}
      >
        <Image 
      ...
      <View style={styles.propertyInfo}>
        ...
        <View style={styles.actionButtons}>
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('EditProperty' as never, { propertyId: item.id } as never)}
          >
