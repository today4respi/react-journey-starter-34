...
import { getPropertyById, updateProperty, PropertyData, Property } from '../../services/propertyService';

/**
 * Écran de modification d'une propriété existante
 * Permet de modifier toutes les informations et de changer l'image
 */
const EditPropertyScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const imageToUpload = image !== property?.image ? image : null;
