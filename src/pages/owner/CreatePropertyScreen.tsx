...
import { createProperty, PropertyData } from '../../services/propertyService';

/**
 * Écran de création d'une nouvelle propriété
 * Permet de saisir toutes les informations et d'ajouter une image
 */
const CreatePropertyScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await createProperty(formData, image);
      ...
      setError('Impossible de créer la propriété. Veuillez réessayer.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Nouvelle propriété</Text>
        <View style={{ width: 24 }} />
      </View>
        ...
        <View style={styles.formSection}>
          ...
          <View style={styles.formRow}>
            <View style={[styles.formGroup, { flex: 1, marginRight: 8 }]}>
              ...
              <TextInput
                ...
                placeholder="0"
                keyboardType="numeric"
                value={formData.workstations > 0 ? String(formData.workstations) : ''}
            ...
            <View style={[styles.formGroup, { flex: 1, marginLeft: 8 }]}>
              ...
              <TextInput
                ...
                placeholder="0"
                keyboardType="numeric"
                value={formData.meeting_rooms > 0 ? String(formData.meeting_rooms) : ''}
          ...
          <View style={styles.formGroup}>
            ...
            <TextInput
              ...
              placeholder="0"
              keyboardType="numeric"
              value={formData.area > 0 ? String(formData.area) : ''}
