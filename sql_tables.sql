...
INSERT INTO `products` (`reference_product`, `nom_product`, `img_product`, `img2_product`, `description_product`, `type_product`, `category_product`, `itemgroup_product`, `price_product`, `qnty_product`, `s_size`, `m_size`, `l_size`, `xl_size`, `xxl_size`, `color_product`, `collection_product`, `status_product`, `discount_product`) VALUES
-- Sur Mesure - Homme
('SM-H-BLZ-001', 'Blazer Sur Mesure Homme', '/placeholder.svg', '/placeholder2.svg', 'Blazer élégant sur mesure pour homme', 'sur mesure', 'homme', 'blazers', 1200.00, 15, 0, 0, 0, 0, 0, 'Navy', 'Wedding Package', 'active', 0.00),
('SM-H-BLO-001', 'Blouson Cuir Sur Mesure', '/placeholder.svg', '/placeholder2.svg', 'Blouson en cuir sur mesure', 'sur mesure', 'homme', 'blouson', 2500.00, 8, 0, 0, 0, 0, 0, 'Black', 'Collection Hiver', 'active', 15.00),
('SM-H-MAN-001', 'Manteau Laine Sur Mesure', '/placeholder.svg', '/placeholder2.svg', 'Manteau en laine pure sur mesure', 'sur mesure', 'homme', 'manteau', 1800.00, 12, 0, 0, 0, 0, 0, 'Charcoal', 'Collection Hiver', 'active', 0.00),
('SM-H-DJI-001', 'Djine Traditionnel Sur Mesure', '/placeholder.svg', '/placeholder2.svg', 'Djine traditionnel sur mesure', 'sur mesure', 'homme', 'djine', 800.00, 20, 0, 0, 0, 0, 0, 'White', 'Collection Traditionnelle', 'active', 0.00),
('SM-H-SLA-001', 'Slack Premium Sur Mesure', '/placeholder.svg', '/placeholder2.svg', 'Pantalon slack premium sur mesure', 'sur mesure', 'homme', 'slack', 650.00, 25, 0, 0, 0, 0, 0, 'Gray', 'Collection Business', 'active', 10.00),
('SM-H-PAN-001', 'Pantalon Classique Sur Mesure', '/placeholder.svg', '/placeholder2.svg', 'Pantalon classique sur mesure', 'sur mesure', 'homme', 'pantalon', 450.00, 30, 0, 0, 0, 0, 0, 'Black', 'Collection Classique', 'active', 0.00),

-- Sur Mesure - Femme
('SM-F-CHE-001', 'Chemise Femme Sur Mesure', '/placeholder.svg', '/placeholder2.svg', 'Chemise élégante sur mesure pour femme', 'sur mesure', 'femme', 'chemise', 380.00, 22, 8, 12, 8, 2, 0, 'White', 'Collection Business', 'active', 0.00),
('SM-F-COS-001', 'Costume Femme Sur Mesure', '/placeholder.svg', '/placeholder2.svg', 'Costume complet sur mesure pour femme', 'sur mesure', 'femme', 'costume', 1500.00, 10, 5, 8, 6, 1, 0, 'Navy', 'Wedding Package', 'active', 20.00),
('SM-F-BLZ-001', 'Blazer Femme Sur Mesure', '/placeholder.svg', '/placeholder2.svg', 'Blazer féminin sur mesure', 'sur mesure', 'femme', 'blazer', 950.00, 18, 6, 10, 8, 2, 0, 'Burgundy', 'Collection Automne', 'active', 0.00),

-- Prêt à Porter
('PAP-CHE-001', 'Chemise Prêt à Porter', '/placeholder.svg', '/placeholder2.svg', 'Chemise classique prêt à porter', 'prêt à porter', '', 'chemise', 120.00, 50, 10, 15, 20, 5, 0, 'Blue', 'Collection Été', 'active', 5.00),
('PAP-TSH-001', 'T-shirt Premium Cotton', '/placeholder.svg', '/placeholder2.svg', 'T-shirt en coton premium', 'prêt à porter', '', 'tshirt', 45.00, 80, 15, 25, 30, 10, 0, 'White', 'Collection Casual', 'active', 0.00),
('PAP-POL-001', 'Polo Élégant', '/placeholder.svg', '/placeholder2.svg', 'Polo élégant pour toutes occasions', 'prêt à porter', '', 'polo', 85.00, 60, 12, 20, 18, 8, 2, 'Navy', 'Collection Sport', 'active', 10.00),
('PAP-CHA-001', 'Chaussures Cuir', '/placeholder.svg', '/placeholder2.svg', 'Chaussures en cuir véritable', 'prêt à porter', '', 'chaussure', 280.00, 40, 0, 0, 0, 0, 0, 'Brown', 'Collection Classique', 'active', 15.00),
('PAP-CEI-001', 'Ceinture Cuir Premium', '/placeholder.svg', '/placeholder2.svg', 'Ceinture en cuir premium', 'prêt à porter', '', 'ceinture', 95.00, 35, 0, 0, 0, 0, 0, 'Black', 'Collection Accessoires', 'active', 0.00),
('PAP-MAR-001', 'Portefeuille Maroquinerie', '/placeholder.svg', '/placeholder2.svg', 'Portefeuille en cuir de maroquinerie', 'prêt à porter', '', 'maroquinerie', 150.00, 45, 0, 0, 0, 0, 0, 'Brown', 'Collection Maroquinerie', 'active', 0.00),

-- Accessoires
('ACC-CRA-001', 'Cravate Soie Premium', '/placeholder.svg', '/placeholder2.svg', 'Cravate en soie de haute qualité', 'accessoires', '', 'cravate', 65.00, 100, 0, 0, 0, 0, 0, 'Red', 'Collection Business', 'active', 0.00),
('ACC-POC-001', 'Pochette Élégante', '/placeholder.svg', '/placeholder2.svg', 'Pochette élégante pour costume', 'accessoires', '', 'pochette', 35.00, 75, 0, 0, 0, 0, 0, 'Silver', 'Collection Accessoires', 'active', 0.00),
('ACC-MAR-001', 'Sac Maroquinerie Luxe', '/placeholder.svg', '/placeholder2.svg', 'Sac de luxe en maroquinerie', 'accessoires', '', 'maroquinerie', 450.00, 25, 0, 0, 0, 0, 0, 'Black', 'Collection Luxe', 'active', 25.00),
('ACC-AUT-001', 'Boutons de Manchette', '/placeholder.svg', '/placeholder2.svg', 'Boutons de manchette en or', 'accessoires', '', 'autre', 180.00, 30, 0, 0, 0, 0, 0, 'Gold', 'Collection Bijoux', 'active', 0.00);
...
-- Create chat_sessions table for managing user chat sessions
CREATE TABLE IF NOT EXISTS `chat_sessions` (
  `id_session` varchar(255) NOT NULL PRIMARY KEY,
...
-- Insert dummy chat sessions
INSERT INTO `chat_sessions` (`id_session`, `client_name`, `client_email`, `client_phone`, `status`, `last_activity`, `date_created`) VALUES
('session_001', 'Jean Dupont', 'jean.dupont@email.com', '+33123456789', 'active', '2024-01-25 15:30:00', '2024-01-25 10:00:00'),
('session_002', 'Marie Martin', 'marie.martin@email.com', '+33987654321', 'active', '2024-01-25 14:45:00', '2024-01-25 09:30:00'),
('session_003', 'Ahmed Ben Ali', 'ahmed.benali@email.com', '+216123456789', 'active', '2024-01-25 13:20:00', '2024-01-24 16:15:00'),
('session_004', 'Sophie Dubois', 'sophie.dubois@email.com', '+33789123456', 'closed', '2024-01-24 11:10:00', '2024-01-24 08:45:00'),
('session_005', 'Fatma Trabelsi', 'fatma.trabelsi@email.com', '+216987654321', 'active', '2024-01-25 16:00:00', '2024-01-25 14:30:00');

-- Insert dummy chat messages
INSERT INTO `chat_messages` (`id_session`, `sender_type`, `sender_name`, `message_content`, `message_type`, `is_read`, `date_sent`) VALUES
-- Session 1 messages
('session_001', 'client', 'Jean Dupont', 'Bonjour, j\'ai une question sur vos costumes sur mesure', 'text', 1, '2024-01-25 10:05:00'),
('session_001', 'agent', 'Agent Support', 'Bonjour Jean ! Je serais ravi de vous aider. Que souhaitez-vous savoir exactement ?', 'text', 1, '2024-01-25 10:07:00'),
('session_001', 'client', 'Jean Dupont', 'Quels sont vos délais de confection pour un costume complet ?', 'text', 1, '2024-01-25 10:10:00'),
('session_001', 'agent', 'Agent Support', 'Pour un costume sur mesure complet, nous avons besoin de 3 à 4 semaines. Cela inclut la prise de mesures, la confection et les essayages finaux.', 'text', 1, '2024-01-25 10:15:00'),
('session_001', 'client', 'Jean Dupont', 'Parfait ! Et pour les prix, pouvez-vous me donner une fourchette ?', 'text', 0, '2024-01-25 15:30:00'),

-- Session 2 messages  
('session_002', 'client', 'Marie Martin', 'Salut ! Je cherche une robe pour un mariage', 'text', 1, '2024-01-25 09:35:00'),
('session_002', 'agent', 'Agent Support', 'Bonjour Marie ! C\'est formidable. Pour quelle date avez-vous besoin de la robe ?', 'text', 1, '2024-01-25 09:40:00'),
('session_002', 'client', 'Marie Martin', 'C\'est pour le 15 mars, donc j\'ai un peu de temps', 'text', 1, '2024-01-25 09:45:00'),
('session_002', 'agent', 'Agent Support', 'Parfait ! Nous aurons largement le temps. Avez-vous déjà une idée du style que vous souhaitez ?', 'text', 1, '2024-01-25 09:50:00'),
('session_002', 'client', 'Marie Martin', 'J\'aimerais quelque chose d\'élégant mais pas trop formel', 'text', 0, '2024-01-25 14:45:00'),

-- Session 3 messages
('session_003', 'client', 'Ahmed Ben Ali', 'Bonsoir, vous livrez en Tunisie ?', 'text', 1, '2024-01-24 16:20:00'),
('session_003', 'agent', 'Agent Support', 'Bonsoir Ahmed ! Oui, nous livrons bien en Tunisie. Les frais de port sont de 25€ pour la Tunisie.', 'text', 1, '2024-01-24 16:25:00'),
('session_003', 'client', 'Ahmed Ben Ali', 'Super ! Et les délais de livraison ?', 'text', 1, '2024-01-24 16:30:00'),
('session_003', 'agent', 'Agent Support', 'Pour la Tunisie, comptez entre 5 à 7 jours ouvrés après expédition.', 'text', 1, '2024-01-24 16:35:00'),
('session_003', 'client', 'Ahmed Ben Ali', 'Merci beaucoup ! Je vais regarder vos produits', 'text', 0, '2024-01-25 13:20:00'),

-- Session 4 messages (closed session)
('session_004', 'client', 'Sophie Dubois', 'Bonjour, j\'ai reçu ma commande mais il y a un problème de taille', 'text', 1, '2024-01-24 08:50:00'),
('session_004', 'agent', 'Agent Support', 'Bonjour Sophie, je suis désolé d\'apprendre cela. Pouvez-vous me donner votre numéro de commande ?', 'text', 1, '2024-01-24 08:55:00'),
('session_004', 'client', 'Sophie Dubois', 'C\'est la commande CMD-2024-004', 'text', 1, '2024-01-24 09:00:00'),
('session_004', 'agent', 'Agent Support', 'Merci. Je vais organiser un échange immédiatement. Vous recevrez un email avec les instructions de retour.', 'text', 1, '2024-01-24 09:10:00'),
('session_004', 'client', 'Sophie Dubois', 'Parfait, merci beaucoup !', 'text', 1, '2024-01-24 11:10:00'),

-- Session 5 messages
('session_005', 'client', 'Fatma Trabelsi', 'Bonjour ! Je voudrais prendre rendez-vous pour des mesures', 'text', 1, '2024-01-25 14:35:00'),
('session_005', 'agent', 'Agent Support', 'Bonjour Fatma ! Bien sûr. Quand seriez-vous disponible ?', 'text', 1, '2024-01-25 14:40:00'),
('session_005', 'client', 'Fatma Trabelsi', 'Cette semaine si possible, plutôt en fin d\'après-midi', 'text', 0, '2024-01-25 16:00:00');
